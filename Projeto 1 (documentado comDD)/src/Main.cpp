...
int tempoSimulacao, tempoMedioChegada, numeroCaixas;
...
/*
	cout << nomeSupermercado << endl;
	cout << "tempo simulacao: " << tempoSimulacao << endl;
	cout << "tempo medio chegada: " << tempoMedioChegada << endl;
...
int main(int argc, char** argv) {
	if (argc < 2) {
		...
		lerConfig(argv[1]);
		supermercado.configurarSimulacao(nomeSupermercado, tempoSimulacao, tempoMedioChegada, &caixas);
