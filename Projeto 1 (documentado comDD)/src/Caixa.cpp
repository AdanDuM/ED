...
int Caixa::receberCliente(Cliente *cliente){
	...
	if(ultimo){
		...
		cliente->saida = tempoDeProcessamento;
	}
 ...
 */
void Caixa::atenderCliente(int horaAtual){
...
*/
	cout<< " Nome caixa: " << nomeCaixa <<endl;
	cout<< " Eficiência: " << eficiencia <<endl;
	cout<< " Salário: " << salario <<endl;
	if(clientesAtendidos){
		cout<< " Tempo médio de permanência de um cliente na fila: " << (tempoMedio / clientesAtendidos ) << " segundos."<<endl;
		cout<< " Número de clientes atendidos: " << clientesAtendidos <<endl;
		cout<< " Faturamento real: " << faturamentoTotal <<endl;
		cout<< " Faturamento medio por clinte: " << (faturamentoTotal / clientesAtendidos) <<endl;
		cout<< " Lucro total do caixa: " << fornecaLucro() <<"\n" <<endl;
	}else{
		cout<< " Nenhum cliente foi atendido por este caixa " <<"\n" <<endl;
	}
}
